...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "GradeFlow — Digital Project Grading Platform" },
      { property: "og:description", content: "Automate project assessment, grading, and supervisor feedback." },
